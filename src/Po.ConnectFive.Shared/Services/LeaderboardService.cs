...
public interface ILeaderboardService
{
    ...
    public Task UpdatePlayerStats(string playerId, PlayerGameResult result, TimeSpan gameTime);
...
public class LeaderboardService : ILeaderboardService
{
    ...
    private const string STORAGEKEY = "playerStats";
    ...
    private async Task<List<PlayerStats>> GetAllPlayerStats()
    {
        try
        {
            var stats = await _storageService.GetItem<List<PlayerStats>>(STORAGEKEY);
    ...
    {
        return _storageService.SetItem(STORAGEKEY, stats);
    }
