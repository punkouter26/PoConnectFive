...
public class GameAnalyticsService
{
    ...
    public Task<MoveAnalysis> AnalyzeMove(GameState gameState, int column, int playerId)
    {
        ...
        {
            analysis.OpeningEvaluation = EvaluateOpening(gameState);
        }
    ...
    private OpeningEvaluation EvaluateOpening(GameState gameState)
    {
        var moves = GetMovesFromBoard();
    ...
    private List<MoveAnalysis> GetMovesFromBoard()
    {
