...
public interface IPlayerDataService
{
    ...
    /// </summary>
    public Task<List<PlayerStats>> GetTopPlayers(AIDifficulty difficulty, int count = 5);
    ...
    /// </summary>
    public Task UpdatePlayerStats(string playerName, AIDifficulty difficulty, PlayerGameResult result, TimeSpan gameTime);
